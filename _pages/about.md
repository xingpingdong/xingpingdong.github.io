...
“High-Fidelity and High-Efficiency Talking Portrait Synthesis With Detail-Aware Neural Radiance Fields”, in **IEEE Transactions on Visualization and Computer Graphics (TVCG)**, vol. 31, no. 9, pp. 6022–6035, 2025. **(SCI, IF=6.5, CCF Rank A)** [IEEE](https://ieeexplore.ieee.org/document/10740602) [code](https://github.com/muyuWang/HHNeRF)
...
in **IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI)**, vol. 47, no. 7, pp. 5475-5488, July 2025. **(SCI, IF=18.6, CCF Rank A)** [IEEE](https://ieeexplore.ieee.org/document/10946205) [code](https://github.com/ouyangtianran/PLCS)
...
in **Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)**, pp. 1505–1515, 2025. **(CCF Rank A)** [Pdf](https://openaccess.thecvf.com/content/CVPR2025/papers/Chen_Rethinking_Temporal_Fusion_with_a_Unified_Gradient_Descent_View_for_CVPR_2025_paper.pdf) [code](https://github.com/cdb342/GDFusion)
...
in **IEEE Transactions on Geoscience and Remote Sensing**, vol. 63, pp. 1–9, 2025. **(SCI, IF=8.6)** [IEEE](https://ieeexplore.ieee.org/document/10942428)

[31] Shuoyi Chen, Mang Ye*, **Xingping Dong**, Bo Du,
“Perception Assisted Transformer for Unsupervised Object Re-Identification”,
in **IEEE Transactions on Image Processing**, vol. 34, pp. 2112–2123, 2025. **(SCI, IF=13.7, CCF Rank A)** [IEEE](https://ieeexplore.ieee.org/document/10944266)

## **2024**
[30] Yukun Zhai, Xiaoqiang Zhang, Xiameng Qin, Sanyuan Zhao*, **Xingping Dong**, Jianbing Shen,
“TextFormer: A Query-Based End-to-End Text Spotter With Mixed Supervision”,
in **Machine Intelligence Research (MIR)**, vol. 21, no. 4, pp. 704–717, 2024. **(SCI, IF=8.7)** [Springer](https://link.springer.com/article/10.1007/s11633-023-1460-6)

[29] **Xingping Dong***, Tianran Ouyang, Shengcai Liao*, Bo Du, Ling Shao, "Pseudo-Labeling Based Practical Semi-Supervised Meta-Training for Few-Shot Learning", in **IEEE Transactions on Image Processing (TIP)**, vol. 33, pp. 5663-5675, 2024. **(SCI, IF=13.7, CCF Rank A)** [arXiv](https://arxiv.org/pdf/2207.06817) [code](https://github.com/ouyangtianran/PLML)
